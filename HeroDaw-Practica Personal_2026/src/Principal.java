...
/**
 * Clase principal que gestiona la interfaz de usuario por consola para la Academia de Héroes.
 * Permite la gestión de equipos, registro de héroes y persistencia de datos en archivos externos.
...
/**
     * Método de entrada de la aplicación. Gestiona el ciclo de vida del menú.
     * * @param args Argumentos de consola [cite: 169]
     */
    ...
    /**
     * Imprime en consola el menú de opciones de la academia.
     */
