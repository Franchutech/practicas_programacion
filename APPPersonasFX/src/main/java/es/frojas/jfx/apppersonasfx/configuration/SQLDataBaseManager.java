package es.frojas.jfx.apppersonasfx.configuration;
...
public class SQLDataBaseManager {
    ...
    private static void lecturaDat() {
        String ruta = "src/main/resources/application_personas.dat";

        try (java.io.BufferedReader br= new BufferedReader
                (new java.io.FileReader("src/main/resources/application_personas.dat"))){
            URL = br.readLine();
            SCHEMA = br.readLine();
            USER = br.readLine();
